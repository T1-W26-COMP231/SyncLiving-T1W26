# Copilot Instructions - Project Guidelines & Structure

This document serves as the primary source of truth for the project's architecture and development rules for **copilot**.
