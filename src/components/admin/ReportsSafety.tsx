            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="px-4 py-3 text-slate-500 text-xs font-bold uppercase tracking-wider">
                      Reported User
                    </th>
                    <th className="px-4 py-3 text-slate-500 text-xs font-bold uppercase tracking-wider">
                      Reason
                    ...
                    <th className="px-4 py-3 text-slate-500 text-xs font-bold uppercase tracking-wider text-right">
                      Action
                    </th>
                  </tr>
                </thead>
