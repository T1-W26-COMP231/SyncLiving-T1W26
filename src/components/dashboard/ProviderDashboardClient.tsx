      ...
      <main className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-slate-500 font-medium">
            Manage your published listings and find the best roommates or
            tenants.
          </p>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
                    Our compatibility-first matching system connects you with
                    individuals who share your lifestyle, values, and living
                    habits for a stress-free shared experience.
                  </p>
                </div>
              </div>
              <button
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed max-w-sm">
                    Ready to fill an empty space? Create a detailed listing with
                    photos, amenities, and roommate preferences to attract
                    high-quality applicants today.
                  </p>
                </div>
              </div>
              <button
        ...
        <div className="space-y-6 pt-4">
          <div className="flex flex-col sm:flex-row justify-between items-end gap-4 border-b border-slate-200 pb-6">
            ...
            <div className="flex gap-1 bg-slate-100 p-1 rounded-full">
              {(["All", "Published", "Archived", "Drafts"] as const).map(
                (tab) => (
                  <button
                    key={tab}
            ...
            {filteredListings.length > 0 ? (
              ...
              <div className="text-center py-24 bg-white rounded-[2rem] border border-dashed border-slate-200">
                ...
                <p className="text-slate-500 font-medium max-w-xs mx-auto mt-2">
                  Try clearing your filters or create your first listing to get
                  started.
                </p>
              </div>
            )}
